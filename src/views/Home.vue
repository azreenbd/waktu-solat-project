            ...
            <div class="box">
                ...
                <div>
                    ...
                    <div class="d-flex flex-wrap">
                        ...
                        <div class="sub-box" v-bind:class="{ active: isSubuh }">
